      ...
      >
        ...
        >
          {/* <p className="mb-10 max-w-2xl font-Ovo">
            ...
            sequi asperiores aspernatur sit, temporibus facilis in eum fugiat
            cum iusto maiores dolorum aliquam possimus reiciendis deserunt
            quidem eius natus culpa!
          </p> */}
          ...
          >
            {infoList.map(({ icon, iconDark, title, description }, index) => (
              ...
              >
                ...
                <p className="text-gray-600 text-sm my-4 dark:text-white/80">
                  {description}
                </p>
              </motion.li>
            ))}
